...
# setwd("//trdecomsrv/H/Oil and Gas/Data/GenTax/CountyVol_Val/")
...
# rmarkdown::render("C:/Users/asifr/OneDrive - State of New Mexico/Desktop/test.R")

##################################################################################################################################################
#read data
#Download this file each month and change the name below
#Change file name
# TAP <- read_xlsx("//trdecomsrv/H/Oil and Gas/Data/GenTax/CountyVol_Val/County Vol_Val By Filing Period 2023_11_03 CY14-CY23.xlsx")
# Legacy_ONGARD <- read_xlsx("//trdecomsrv/H/Oil and Gas/Data/GenTax/CountyVol_Val/HISTORICAL ONGARD LEGACY DATA.xlsx")
# TAP <- read_ods("//trdecomsrv/H/Alphie/Temp/County Vol_Val By Filing Period 202312071223.ods")

Legacy_ONGARD <- read_xlsx("//trdecomsrv/H/Oil and Gas/Data/GenTax/CountyVol_Val/HISTORICAL ONGARD LEGACY DATA.xlsx")
TAP <- read_ods("//trdecomsrv/H/Alphie/Temp/R temp/Oil Tracker Input.ods")

colnames(TAP) <- colnames(Legacy_ONGARD)


# TAP$`Filing Period` <-  as.POSIXct(TAP$`Filing Period`, format = "%Y-%M-%d")

TAP$`Filing Period` <- dmy(TAP$`Filing Period`)
...
Bravo_Dome_NatGas <- subset(Bravo_Dome, Bravo_Dome$`Product Code`=="07" | 
...
pdf_file <- "//trdecomsrv/H/Alphie/Temp/R temp/file.pdf"
pdf(pdf_file)
